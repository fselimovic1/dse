...
def case39():
    ...
    # bus_i (0), baseMVA (1), vn (2), fn (3), modelType(4), xl(5), ra(6), xd(7), x1d(8), x2d(9), T1d(10), T2d(11), xq(12), x1q(13), x2q(14), T1q(15), T2q(16),
    # M(17), D(18), conn_status(19)
    ppc["sg"] = array([
        [ 30, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0310, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 84.0, 1, 1 ],
        [ 31, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0697, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 60.6, 1, 1 ],
        [ 32, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0531, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 71.6, 1, 1 ],
        [ 33, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0436, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 57.2, 1, 1 ],
        [ 34, 100, 1, 60, 4, 0, 0.002, 0.911, 0.1320, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 52.0, 1, 1 ],
        [ 35, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0500, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 69.6, 1, 1 ],
        [ 36, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0490, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 52.8, 1, 1 ],
        [ 37, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0570, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 48.6, 1, 1 ],
        [ 38, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0570, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 69.0, 1, 1 ],
        [ 39, 100, 1, 60, 4, 0, 0.002, 0.911, 0.0060, 0, 4.2, 0, 0.58, 0.58, 0, 3, 0, 1000.0, 1, 1 ],
    ])
